...
def configuration():
    ...
    parser.add_argument("--checkpoint_start", default="/mnt/data1/liyong/HiE-InfoNCE/sues200/convnext_base.fb_in22k_ft_in1k_384/2025_12_08_1451/weights/weights_e50_0.9722.pth", type=str, help="Path to checkpoint to resume training")
